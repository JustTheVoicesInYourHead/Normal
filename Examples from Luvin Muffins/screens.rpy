...
##This screen forces the player's name if they refuse Aki's instructions too many times.
## ########################################################################################
...
screen Force_Typing():
    ...
    key ["K_a", "K_b", "K_c", "K_d", "K_e", "K_f", "K_g", "K_h",
    "K_i", "K_j", "K_k", "K_l", "K_m", "K_n", "K_o", "K_p",
    "K_q", "K_r", "K_s", "K_t", "K_u", "K_v", "K_w", "K_x", "K_y", "K_z"]:
        action Function(next_letter)

    key ["K_RETURN", "K_KP_ENTER"]:
        action Return()

## These screens (should) allow the player to navigate between scenes
## ####################################################################################
...
screen NavigatePark():
    vbox:
        ...
        yfill True
        imagebutton:
            idle "gui/arrowup.png"
            hover Transform("gui/arrowup.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NorthPark")]
            align(0.5, 0.0)        
            focus_mask True

screen NavigateNorthPark():
    vbox:
        xfill True
        yfill True
        imagebutton:
            idle "gui/arrowright.png"
            hover Transform("gui/arrowright.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NorthEastPark")]
            align(1.0, 0.5)       
            focus_mask True
    vbox:
        xfill True 
        yfill True
        imagebutton:
            idle "gui/arrowdown.png"
            hover Transform("gui/arrowdown.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("Park")]
            align(0.5, 1.0)        
            focus_mask True
    vbox:
        ...
        imagebutton:
            ...
            hover Transform("gui/arrowleft.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NorthWestPark")]
            align(0.0, 0.5)       
            focus_mask True
    vbox:
        xfill True
        ...
        imagebutton:
            idle "gui/arrowup.png"
            hover Transform("gui/arrowup.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NortherPark")]
            align(0.5, 0.0)
            focus_mask True

screen NavigateNortherPark():
    vbox:
        xfill True
        yfill True
        imagebutton:
    ...
    vbox:
        ...
        imagebutton:
            idle "gui/arrowup.png"
            hover Transform("gui/arrowup.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NorthestPark")]
            align(0.5, 0.0)
            focus_mask True        

screen NavigateNorthEastPark():
    vbox:
        xfill True
        yfill True
        imagebutton:
...
screen NavigateNorthWestPark():
    ...
    vbox:
        ...
        imagebutton:
            idle "gui/arrowup.png"
            hover Transform("gui/arrowup.png", matrixcolor=TintMatrix("#690606"))
            action[Jump("NorthWestNorthPark")]
            align(0.5, 0.0)       
            focus_mask True

screen NavigateNorthWestNorthPark():
    vbox:
        xfill True
        yfill True
        imagebutton:
